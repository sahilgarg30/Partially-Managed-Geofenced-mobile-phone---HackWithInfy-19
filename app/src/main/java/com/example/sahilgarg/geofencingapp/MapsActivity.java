...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = database.getReference().child("Location");
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        geoService.startService(dangerous_area,rad);
    ...
    public void alert(){
        ...
        try {
            ...
            Ringtone r = RingtoneManager.getRingtone(MapsActivity.this, notification);
            r.play();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                    Toast.makeText(this,"entered the dangerous zone", Toast.LENGTH_LONG).show();
                    ...
                    makeToast("safeZone");
                    databaseReference.child("98765445").setValue("Safe");
...
//                    sendNotification("MRF", String.format("%s exit the dangerous area", key));
                ...
                public void onKeyMoved(String key, GeoLocation location) {
                    Log.d("MOVE", String.format("%s move within the safe area [%f/%f]", key, location.latitude, location.longitude));

                    makeToast("moved within safe Zone");
                    databaseReference.child("98765445").setValue("Safe");
